 ...
 *******************************************************************************
  ...
  作    者: 肖景煊
  生成日期: 2025年11月20日
  功能描述: CAN BSP 头文件，类型选择、结构体与接口声明
  补    充: 无
...
/* CAN 实例结构体定义，所有使用 CAN 的模块应持有该指针 */
 ...
 */
/* 阻塞式发送接口，等待邮箱/队列空闲，超时返回 0 失败 */
uint8_t CANTransmit(CANInstance *_instance,float timeout);

/* 非阻塞发送接口，邮箱/队列空闲则发送并返回 1，否则返回 0 */
uint8_t CANTransmitTry(CANInstance *_instance);

/* 零拷贝发送接口，使用外部数据缓冲与长度，立即发送 */
